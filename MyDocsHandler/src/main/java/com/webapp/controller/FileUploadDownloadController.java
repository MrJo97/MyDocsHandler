...
import com.webapp.model.committente.*;
import com.webapp.model.documento.*;
...
public class FileUploadDownloadController {
	...
	{	
		...
		{		tx.commit();
			...
			model.addObject("doc", document);  //popolazione della form con i dati inseriti dall'utente. 
			model.addObject("operation", "loading");
			return model;
		}
		else
