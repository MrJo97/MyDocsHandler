...
<div id="container1">
<div id="container2">
<p>Se non sei ancora registrato clicca <a href="/MyDocsHandlerNew/goToRegistrationForm.html">qui</a>.</p>
<form action="/MyDocsHandlerNew/LoginForm.html" method="post">
<table id="table">
