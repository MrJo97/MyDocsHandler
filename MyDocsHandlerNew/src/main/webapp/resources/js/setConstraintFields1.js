	...
	//form validation dei campi dati del documento
	 ...
	 //form validation dei campi dati del committente
		...
		$(document.body).on('change', function()
		{
			...
			console.log("isTheCustomerNameTyped  " + isTheCustomerNameTyped);
			...
			console.log("abilito: "+ (isTheDocSelected && ((isTheCustomerNameTyped && isTheCustomerSurnameTyped && isTheCustomerTelTyped 
					&& isTheCustomerEmailTyped) || $("#sru").value != "selectCustomer")));
			
		//abilitazione del bottone "salva modifiche"
			if(isTheDocSelected && ((isTheCustomerNameTyped && isTheCustomerSurnameTyped && isTheCustomerTelTyped && isTheCustomerEmailTyped) || $("#sru").val() != "selectCustomer"))
			{
